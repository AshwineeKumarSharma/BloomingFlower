...
{
    public class AcademicImageUpdateController : Controller
    {
        // GET: Admin/AcademicImageUpdate
        public ActionResult Index()
        {
            return View();
        }
        [HttpPost]
        public ActionResult Index(AcademicImageUpdateViewmodel el,HttpPostedFileBase Image)
        {
            MyDbContext db = new MyDbContext();
            AcademicActivitiesImagesInfo AAI = new AcademicActivitiesImagesInfo();
            ...
            if (ModelState.IsValid)
            {
                ...
                string path = Path.Combine(Server.MapPath("~/Extras/AcademicActivitiesImages"), fileName);
                ...
                db.AcademicActivitiesImagesInfoes.Add(AAI);
                db.SaveChanges();
